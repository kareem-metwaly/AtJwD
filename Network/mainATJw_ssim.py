...
parser.add_argument("--ID", default="ssim", type=str, help='ID for training')
parser.add_argument("--model", default="dense_121_A_t_J_w_allSE", type=str, help="unet or drrn or runet")
